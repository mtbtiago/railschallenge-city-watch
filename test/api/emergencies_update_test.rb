...
class EmergenciesUpdateTest < ActionDispatch::IntegrationTest
  ...
  test 'PATCH /emergencies/:name can change fire_severity' do
  ...
  test 'PATCH /emergencies/:name can change police_severity' do
  ...
  test 'PATCH /emergencies/:name can change medical_severity' do
  ...
  test 'PATCH /emergencies/:name can change resolved_at' do
  ...
  test 'PATCH /emergencies/:name cannot change code (it is fixed once created)' do
